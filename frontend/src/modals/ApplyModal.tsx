    ...
    return(
        <div className="w-full modalbg flex items-center justify-center max-h-screen fixed inset-0 z-50">
            <div className="flex flex-col items-center space-y-6 bg-white_gray px-10 rounded-md w-[90%] md:w-[461px] py-8">
                ...
                <button onClick={handleApply} className="block py-2.5 px-6 bg-dark_purple border-2 border-transparent hover:border-dark_purple hover:bg-white hover:text-dark_purple text-white font-bold rounded-3xl">
                    Apply {" "}
                    {
