  ...
  return (
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          <button 
            onClick={() => navigate("/dashboard/roles/shuffling")}
            className="flex w-full items-center justify-center gap-2 rounded-full bg-customPurple p-6 font-bold text-white">
      ...
      <div className="mt-6 flex flex-col justify-between gap-4 md:flex-row">
        <button className="flex w-full items-center justify-center gap-4 rounded-full border border-blue-500 bg-blue-300 px-8 py-4 text-blue-500">FREEZE  <TfiBarChartAlt /></button>
        <button className="flex w-full items-center justify-center gap-4 rounded-full bg-red-600 px-8 py-4 text-white">END POST <TfiBarChartAlt/> </button>
      </div>
    </div>
  );
}
