...
const RoleTalentActions = () => {
  return (
    <div className="mx-auto w-full overflow-hidden rounded-[2rem] text-white shadow-lg">
      {/* Top section */}
      <div className="grid grid-cols-2">
        {/* Post a New Role */}
        <div className="flex flex-col items-center justify-end gap-12 bg-[#3D00A0] px-6 md:flex-row">
          ...
          <img src={postImg} alt="Post a role" className="mt-4 w-12 md:mt-0 md:w-24" />
        </div>

        {/* Search a Talent */}
        <div className="flex flex-col items-center justify-end gap-12 bg-[#FFE600] px-6 text-[#3D00A0] md:flex-row">
          <div className="flex gap-3 space-y-2 text-center md:text-left">
            <h3 className="text-lg font-semibold">Search a talent</h3>
            <AiOutlineUsergroupAdd className="mx-auto md:mx-0" />
          </div>
          <img src={searchImg} alt="Search talent" className="mt-4 w-12 md:mt-0 md:w-20" />
        </div>
      </div>

      {/* Bottom section */}
      <div className="flex items-center justify-center gap-2 bg-[#763DFF] py-5 text-center text-lg font-bold tracking-wide text-white">
